...
class csrng_base_test extends dv_base_test #(
    .CFG_T(csrng_env_cfg),
    .ENV_T(csrng_env)
  );
  ...
  virtual task run_phase(uvm_phase phase);
    fork
      ...
      // If the agent is active then run_layered_register_vseq() will issue the register accesses
      // via ahb_mgr_driver to ahb_if.
