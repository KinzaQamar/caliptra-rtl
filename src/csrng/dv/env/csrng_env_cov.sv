...
class csrng_env_cov extends dv_base_env_cov #(.CFG_T(csrng_env_cfg));
  `uvm_component_utils(csrng_env_cov)
...
function csrng_env_cov::new(string name, uvm_component parent);
  super.new(name, parent);
endfunction

function void csrng_env_cov::build_phase(uvm_phase phase);
