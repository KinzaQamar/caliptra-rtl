...
class csrng_intr_vseq extends csrng_base_vseq;
  ...
  task test_cs_entropy_req();
    ...
    csr_rd_check(.ptr(ral.INTERRUPT_STATE.CS_ENTROPY_REQ), .compare_value(1'b1));
    check_interrupts(.interrupts((1 << EntropyReq)), .check_set(1'b1));
    cfg.clk_rst_vif.wait_clks(100);
    // Make sure the interrupt bit is cleared
    csr_rd_check(.ptr(ral.INTERRUPT_STATE.CS_ENTROPY_REQ), .compare_value(1'b0));
  ...
  task test_cs_hw_inst_exc();
    ...
    csr_spinwait(.ptr(ral.INTERRUPT_STATE.CS_HW_INST_EXC), .exp_data(1'b1));
    cov_vif.cg_err_code_sample(.err_code(32'b0));
    ...
    cfg.clk_rst_vif.wait_clks(100);
    // Make sure the interrupt bit is cleared
    csr_rd_check(.ptr(ral.INTERRUPT_STATE.CS_HW_INST_EXC), .compare_value(1'b0));
  ...
  task test_cs_fatal_err();
    ...
    // Enable intr_state
    csr_wr(.ptr(ral.INTERRUPT_ENABLE), .value(32'd15));
    ...
    case (cfg.which_fatal_err) inside
      ...
      sfifo_ggenreq_error: begin
        ...
        if (cfg.which_fatal_err == sfifo_updreq_error ||
          ...
          force_all_fifo_errs_exception(fifo_forced_paths, fifo_forced_values, path_exts,
                                        ral.INTERRUPT_STATE.CS_FATAL_ERR, 1'b1, cfg.which_fifo_err);
        end else begin
      ...
      drbg_updob_sm_error: begin
        ...
        force_path_err(path, 8'b0, ral.INTERRUPT_STATE.CS_FATAL_ERR, 1'b1);
      end
      aes_cipher_sm_error: begin
        ...
        case (cfg.which_aes_cm) inside
          fsm_sparse, fsm_redun: begin
            ...
            force_path_err(aes_fsm_path, value3, ral.INTERRUPT_STATE.CS_FATAL_ERR, 1'b1);
          end
          ctrl_sparse: begin
            ...
            if (aes_pkg::SP2V_LOGIC_HIGH[cfg.which_sp2v] == 1'b1) begin
              ...
              force_path_err(path, value3, ral.INTERRUPT_STATE.CS_FATAL_ERR, 1'b1);
            end else begin
          ...
          ctr_redun: begin
            ...
            if (aes_pkg::SP2V_LOGIC_HIGH[cfg.which_sp2v] == 1'b1) begin
              ...
              force_path_err(path, value4, ral.INTERRUPT_STATE.CS_FATAL_ERR, 1'b1);
            end else begin
      ...
      cmd_gen_cnt_error: begin
        ...
        force_path_err(path, 8'h01, ral.INTERRUPT_STATE.CS_FATAL_ERR, 1'b1);
      end
      fifo_write_error, fifo_read_error, fifo_state_error: begin
        ...
        begin
          force_fifo_err_exception(path1, path2, 1'b1, 1'b0, 1'b0, ral.INTERRUPT_STATE.CS_FATAL_ERR,
                                   1'b1);
        end else begin
          force_fifo_err(path1, path2, value1, value2, ral.INTERRUPT_STATE.CS_FATAL_ERR, 1'b1);
        end
      end
      default: begin
  ...
  task body();
    ...
    $assertoff(0, "tb.dut.u_csrng_core.u_caliptra_prim_arbiter_ppc_updblk_arb.LockArbDecision_A");
    $assertoff(0, "tb.dut.u_csrng_core.u_caliptra_prim_arbiter_ppc_benblk_arb.ReqStaysHighUntilGranted0_M");
    $assertoff(0, "tb.dut.u_csrng_core.u_caliptra_prim_arbiter_ppc_updblk_arb.ReqStaysHighUntilGranted0_M");
    ...
    if (cfg.which_fatal_err inside {cmd_stage_sm_err, main_sm_err,
      ...
      csr_rd_check(.ptr(ral.INTERRUPT_STATE), .compare_value(4'b1000));
    end else begin
      ...
      csr_rd_check(.ptr(ral.INTERRUPT_STATE), .compare_value(4'b0));
    end
    ...
    $asserton(0, "tb.dut.u_csrng_core.u_caliptra_prim_arbiter_ppc_updblk_arb.LockArbDecision_A");
    $asserton(0, "tb.dut.u_csrng_core.u_caliptra_prim_arbiter_ppc_benblk_arb.ReqStaysHighUntilGranted0_M");
    $asserton(0, "tb.dut.u_csrng_core.u_caliptra_prim_arbiter_ppc_updblk_arb.ReqStaysHighUntilGranted0_M");
