...
module tb;
  ...
  `define CTR_DRBG_GEN_FIFO `CTR_DRBG_GEN.u_caliptra_prim_fifo_sync_bencack.gen_normal_fifo
  ...
  `define CTR_DRBG_UPD_FIFO `CTR_DRBG_UPD.u_caliptra_prim_fifo_sync_bencack.gen_normal_fifo
