...
interface csrng_cov_if (
  ...
  assign hw0_genbits_depth =
    u_csrng_core.gen_cmd_stage[0].u_csrng_cmd_stage.u_caliptra_prim_fifo_genbits.depth_o;
  assign hw1_genbits_depth =
    u_csrng_core.gen_cmd_stage[1].u_csrng_cmd_stage.u_caliptra_prim_fifo_genbits.depth_o;
  assign sw_genbits_depth =
    u_csrng_core.gen_cmd_stage[2].u_csrng_cmd_stage.u_caliptra_prim_fifo_genbits.depth_o;
